                ...
                <div className="relative">
                  ...
                  {competitiveness && currentRent && (
                    <div className={cn(
                      ...
                      competitiveness.status === 'competitive' ? "bg-emerald-500/10 border-emerald-500/30" :
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-dark-800/50 border border-gray-700">
                      ...
                      <span className={cn(
                        "font-medium",
                        item.isPositive ? "text-emerald-400" : "text-gray-300"
                      )}>
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div className={cn(
                          ...
                          comp.similarityScore >= 80 ? "bg-emerald-500/20 text-emerald-400 border border-emerald-500/30" :
