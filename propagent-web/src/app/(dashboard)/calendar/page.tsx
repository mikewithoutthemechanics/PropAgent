          ...
          <div className="glass-card rounded-2xl max-w-md w-full p-6 animate-on-scroll">
            ...
            <div className="space-y-4">
              <div>
                ...
                >
                  <option className="bg-gray-900" value="">Select a property...</option>
                  <option className="bg-gray-900" value="45 Beach Road, Umhlanga">45 Beach Road, Umhlanga</option>
                  <option className="bg-gray-900" value="12 Lagoon Drive, Ballito">12 Lagoon Drive, Ballito</option>
                  <option className="bg-gray-900" value="8 Marine Parade, Durban">8 Marine Parade, Durban</option>
                </select>
              </div>
