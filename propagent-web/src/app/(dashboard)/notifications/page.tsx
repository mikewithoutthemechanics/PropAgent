...
export default function NotificationsPage() {
  ...
  const statCards = [
    ...
    { icon: <AlertTriangle className="w-5 h-5 text-amber-400" />, value: unreadCount, label: 'Unread', color: 'amber' },
  ...
  return (
    <div ref={pageRef} className="space-y-6 relative">
        ...
        <div className="relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              {unreadCount > 0 && (
                <Button variant="outline" size="sm" onClick={handleMarkAllAsRead} className="glass hover:bg-amber-500/20">
                  <CheckCheck className="w-4 h-4 mr-2 text-amber-400" />
                  <span className="text-amber-400">Mark all read</span>
                </Button>
              )}
              <Button 
                ...
                className={showSettings ? "glow-gold" : "glass hover:bg-amber-500/20"}
              >
      ...
      {showSettings ? (
        <div className={cn("glass-card rounded-xl border border-amber-500/20", isVisible && "animate-on-scroll visible")}>
          <div className="flex items-center gap-3 mb-6 p-4 border-b border-amber-500/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
            <div className="space-y-4">
              <h3 className="font-medium text-amber-400">Notification Channels</h3>
              <div className="space-y-3">
                {[
                  ...
                  <label key={key} className="flex items-center justify-between p-3 rounded-lg border border-amber-500/20 hover:bg-slate-800/50 cursor-pointer glass">
                    ...
                    <input
                      ...
                      className="w-4 h-4 text-amber-500 rounded border-amber-500/30 focus:ring-amber-500"
                    />
                  </label>
                ))}
              </div>
            ...
            <div className="space-y-4">
              <h3 className="font-medium text-amber-400">Notification Types</h3>
              <div className="space-y-3">
                {[
          ...
          <div className="mt-6 pt-6 border-t border-amber-500/20 p-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="font-medium text-amber-400">Quiet Hours</h3>
          ...
          <div className="mt-6 p-4 glass rounded-lg border border-amber-500/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className={cn("glass-card rounded-xl overflow-hidden border border-amber-500/20 lg:col-span-2", isVisible && "animate-on-scroll visible")}>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className={cn(
                          ...
                          !notification.read ? "bg-amber-500/20" : "bg-slate-800/50"
                        )}>
                          <IconComponent className={cn(
                            "w-5 h-5",
                            !notification.read ? "text-amber-400" : "text-slate-400"
                          )} />
                        </div>
            ...
            {selectedNotification ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-2xl text-amber-400">{getNotificationIcon(selectedNotification.type)}</span>
                ...
                {selectedNotification.metadata && (
                  <div className="space-y-2">
                    <p className="text-xs font-medium text-amber-400 uppercase">Additional Details</p>
