        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, i) => (
              <div 
                key={i} 
                className={`relative bg-white/15 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-lime-400/40 hover:bg-white/25 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-lime-500/10 group focus-within:ring-2 focus-within:ring-white/30 focus-within:ring-offset-2 focus-within:ring-charcoal-900 ${prefersReducedMotion ? '' : visibleSections.has('testimonials') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
