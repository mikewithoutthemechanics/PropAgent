export const metadata = {
  title: 'Terms of Service — AgentPing',
};
  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 prose prose-slate">
      ...
      <p className="text-charcoal-600">
        These terms govern your use of AgentPing. By creating an account or using
      ...
      <p className="text-charcoal-600">
        The platform is provided &ldquo;as is&rdquo;. AgentPing is not liable for
      ...
      <p className="text-charcoal-600">
        Questions? Email <a className="underline" href="mailto:hello@agentping.co.za">hello@agentping.co.za</a>.
      </p>
    </main>
  );
}
